"""
Django settings for testingapprt_2 project.
...
ROOT_URLCONF = 'testingapprt_2.urls'
...
WSGI_APPLICATION = 'testingapprt_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "testingappRT Support <support@testingapprt-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testingapprt_2 API",
    "DESCRIPTION": "API documentation for testingapprt_2 App",
    "VERSION": "v1",
}
